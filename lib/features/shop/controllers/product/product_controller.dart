...
class ProductController extends GetxController {
  ...
  String getProductsPrice(ProductModel product) {
    ...
    if (product.productType == ProductType.single.toString()) {
      ...
      for (var variation in product.productVariations!) {
        /// Determine the price to consider (sale price if available, attribute regular price).
      ...
      /// If smallest and largest prices are the same, return a simple price
  ...
  String getProductStockStatus(int stock) {
    return stock > 0 ? "En Stock" : "En Rupture";
  }
}
